...
GenSlides 是一个本地运行的单页应用，用于生成和展示 AI 图片幻灯片。用户可以编写文字描述，系统使用 Nano Banana Pro 生成对应的图片，并以走马灯（轮播）的形式全屏播放。
...
- 根据 slide 的文字内容调用 Nano Banana Pro 生成图片
